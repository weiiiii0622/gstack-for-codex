...
1. **Project-scoped test plans:** Check `$GSTACK_STATE_ROOT/projects/` for recent `*-test-plan-*.md` files for this repo
   ```bash
...
```
Write to `$GSTACK_STATE_ROOT/projects/{slug}/{user}-{branch}-test-outcome-{datetime}.md`
