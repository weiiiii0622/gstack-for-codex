...
`$GSTACK_STATE_ROOT/projects/$SLUG/designs/` (user config directory, not project files).
...
|----------------|-------------|-----------|-------|
| [screen name]  | $GSTACK_STATE_ROOT/projects/$SLUG/designs/[folder]/[filename].png | [brief description] | [constraints from review] |
```
